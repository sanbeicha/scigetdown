...
class Ui_Form(object):
    def setupUi(self, Form) -> None:
        ...
        self.label.setPixmap(QPixmap(":/images/icon_128x128.png"))
        ...
        self.label_bbh.setObjectName("label_bbh")
        font1 = QFont()
        ...
        self.pushButton_gfwz.setObjectName("pushButton_gfwz")
    ...
    def retranslateUi(self, Form) -> None:
        ...
        self.label_bbh.setText(
            QCoreApplication.translate("Form", "\u6700\u65b0\u7248\u672c:2.0 \u5f53\u524d\u7248\u672c:1.0", None)
        )
        self.label_3.setText(QCoreApplication.translate("Form", "\u7248\u672c\u63cf\u8ff0", None))
        self.label_zt.setText(
            QCoreApplication.translate(
                "Form", "\u6587\u4ef6\u5927\u5c0f \u4e0b\u8f7d\u901f\u5ea6 \u5269\u4f59\u65f6\u95f4", None
            )
        )
        self.pushButton_tgbb.setText(QCoreApplication.translate("Form", "\u8df3\u8fc7\u7248\u672c", None))
